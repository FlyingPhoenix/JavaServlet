...
public class DBServletContextListener implements ServletContextListener,
    ...
    public DBServletContextListener() {
    }
    ...
    public void contextInitialized(ServletContextEvent sce) {
      ...
      */
        ...
        ctx.setAttribute("address", address);
        DBWorkerWithContext dbWorkerWithContext = new DBWorkerWithContext(url,user,password);
        ctx.setAttribute("DBManager", dbWorkerWithContext);
